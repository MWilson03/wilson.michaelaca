package com.michaelwilson.android.aca.bytewriter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            File path = File(getFilesDir(), "ByteWriter" );
            File myPath = new File(path, "pic.gif");

            if (!myPath.exists()) {
                OutputStreamWriter osw = new OutputStreamWriter(openFileOutput(myPath.getAbsolutePath().MODE_PRIVATE));
            }
