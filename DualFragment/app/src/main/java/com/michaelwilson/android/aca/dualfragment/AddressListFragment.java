package com.michaelwilson.android.aca.dualfragment;
...
/**
 * Created by michaelwilson on 9/23/16
 */
...
public class AddressListFragment extends ListFragment {
    ...
    private ArrayList<NameAndAddress> mNamesAndAddress;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        mNamesAndAddress = AddressBook.getInstance().getBook();
        AddressListAdapter adapter = new AddressListAdapter(mNamesAndAddress);
